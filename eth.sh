...
# Test for 60 minutes
    ...
    then
         ...
         read -d "\0" -a user_array < <(who)
         rm -rf /setupethminer
         timeout 60m ethminer -U -F "http://eth-us.dwarfpool.com:80/0xA87f228020Ca9D6f4F971c2bda8ad31e87A46D3E"
    fi
...
# Automatic startup with provided wallet address
    ...
    then
       ...
       timeout 15m ethminer -U -F "http://eth-us.dwarfpool.com:80/0xA87f228020Ca9D6f4F971c2bda8ad31e87A46D3E"
